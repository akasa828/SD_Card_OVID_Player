...
/* f_mkfs() 在板上格式化。本功能只挂载和读取，不在板上格式化 → 关掉省 flash。 */
...
/* Project extension: report full FAT free-space scan progress to the app UI. */
#define FF_USE_FREE_SCAN_PROGRESS 1
#define FF_USE_DIR_SCAN_GUARD 1
